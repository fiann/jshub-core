...
The gem list is configured in the <tt>environment.rb</tt> file should you wish more information on the specific gems and versions needed.
...
For other deployment instructions please see the {doc/help/deployment.rdoc}[link:files/doc/help/deployment_rdoc.html] file
...
For more detailed instructions please see the {doc/help/testing.rdoc}[link:files/doc/help/testing_rdoc.html] file.
...
Please refer to the local help pages at {doc/help}[link:index.html]

Run <tt>rake -T</tt> to find other tasks in the <tt>jshub</tt> namespace

The best place to get other support is on the mailing list:

  http://jshub.org/mailing-list/
