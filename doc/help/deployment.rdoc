...
The jsHub application comes pre-configured to run on the URL <tt>/core/</tt> and this can be changed in the <tt>environments/passenger.rb</tt> file.
...
Deployment is undertaken using Capistrano